...
- **COMMIT YOUR WORK (EVERY ITERATION)** - After completing the task and updating SPECS.md, create exactly ONE git commit for the iteration
...
When ALL tasks in SPECS.md are complete:
```
<ralph_status>
COMPLETE
</ralph_status>
